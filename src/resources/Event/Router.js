...
const { POST_CreateEvent, PUT_UpdateEvent, DELETE_RemoveEvent, GET_EventDetail, GET_SearchEvents, POST_UploadCK, GET_EventView, PUT_UpdateTicketTypesOfEvent } = require('./Resolver');
